				...
				<div id="courses-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam1.jpg')}}" alt="">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam2.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<div class="course-details">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam3.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam4.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam5.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam6.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam7.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{asset('web/assets/img/exam8.jpg')}}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
